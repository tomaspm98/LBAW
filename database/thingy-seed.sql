...
VALUES ('admin', 'admin@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-01-15', 0),
       ...
       ('member2', 'member2@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-05-23', 0),
       ('member3', 'member3@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-05-23', 0),
       ('member4', 'member4@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-05-23', 0),
       ('member5', 'member5@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-05-23', 0),
       ('member6', 'member6@example.com', '$2y$10$KwpGjvc/KlEieFZjHD4AKe1Lj16ue9zUaQf6GLrfOXsN6.Kra/iPS', 'public/pictures/default/profile_picture.png', '1990-05-23', 0);
...
VALUES ('How to program in Python?', 1, NULL, 3, 'I want to learn Python programming. Any advice is helpful.'),             -- Question from member1
       ('Database design tips', 2, NULL, 2, 'I need advice on using docker with a database. Any help is appreciated.'),
       ('Best practices for front-end development?', 3, NULL, 4, 'Seeking recommendations for optimizing front-end code and design.'),
       ('Understanding machine learning algorithms', 4, NULL, 5, 'I am new to machine learning. Can someone explain common algorithms and their applications?'),
       ('Effective ways to improve SQL performance?', 2, NULL, 6, 'Looking for strategies to optimize SQL queries and database performance.'),
       ('Cybersecurity measures for small businesses', 6, NULL, 7, 'What are the essential security practices small businesses should implement to protect data?'),
       ('Tips for building scalable web applications?', 3, NULL, 8, 'Interested in learning techniques for building web apps that can handle increased user traffic and growth.');
